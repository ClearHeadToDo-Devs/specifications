...
- Optional synchronization mechanisms may keep workspace resources available across devices, but must preserve the authoritative plaintext and projection boundaries defined by the workspace and iCalendar specifications.
